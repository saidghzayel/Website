...
<h1 class="page_heading"><?php _e('Archive for <span class="archive_select"> ','vibration'); ?>
...
<?php  echo '<span class="archive_select">'.the_time('F,Y').'</span>'; ?>

<?php } elseif(is_author()){ _e('Author','vibration').''.get_option('skypanel_vibration_archive').'' ;  ?>

<?php echo '<span class="archive_select">'; ?>
...
elseif(is_tag()){ echo _e('Tag: ','vibration');
