...
<h2>Podcasting Settings</h2>
		...
		<?php $this->nonceField(); ?>
            ...
            <em>
                ...
                The Podcasting plugin is brought to The Software Group.
			</em></p>
					...
					<td>
						<p style="margin: 7px 0;"><strong>
							...
							if ($wp_rewrite->using_permalinks())					
								...
								echo get_option('home') . wp_dropdown_categories( ) . '/?feed=podcast'; ?>
						</strong></p>
                        <br />
					...
					<table cellpadding="3" class="pod_format">
						<tr>
							...
							<td colspan="3">
								...
								if ($wp_rewrite->using_permalinks())
									echo "/feed/podcast/?format=$pod_format->slug";
								else
